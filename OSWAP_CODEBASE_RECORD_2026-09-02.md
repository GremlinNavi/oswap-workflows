...
| `oswap-workflows` | OSWAP Standard for Auditable Code Workflows plugin | `ef934723f31ec3273f4884d9217318a02231861d` | Local Git repository; no remote configured at record time |
